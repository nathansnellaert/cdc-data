"""Transform BRFSS Nutrition, Physical Activity, and Obesity dataset."""
...
DATASET_ID = "cdc_brfss_obesity"
SOURCE_ID = "hn4x-zwk7"

METADATA = {
    "id": DATASET_ID,
    "title": "CDC BRFSS Nutrition, Physical Activity, and Obesity",
    "description": (
        "State-level data on nutrition, physical activity, and obesity prevalence "
        "from the Behavioral Risk Factor Surveillance System (BRFSS). "
        "Includes demographic breakdowns by income, education, age, and other factors. "
    ...
    "column_descriptions": {
        ...
        "stratification_category": "Demographic stratification category",
...
def run():
    """Transform, validate, and upload BRFSS obesity data."""
