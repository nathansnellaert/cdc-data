"""Transform CDC STATE System E-Cigarette Legislation - Smokefree Indoor Air dataset."""
...
DATASET_ID = "cdc_ecig_smokefree_indoor_legislation"
SOURCE_ID = "wan8-w4er"

METADATA = {
    "id": DATASET_ID,
    "title": "CDC E-Cigarette Smokefree Indoor Air Legislation by State",
    "description": (
        "State-level e-cigarette smokefree indoor air legislation data from the CDC STATE System. "
        "Tracks restrictions on e-cigarette/vaping use in various indoor locations including "
        "restaurants, bars, workplaces, day care centers, and other venues. "
...
def run():
    """Transform, validate, and upload e-cigarette smokefree legislation dataset."""
