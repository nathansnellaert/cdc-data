"""Transform E-Cigarette Licensure Legislation dataset."""
...
DATASET_ID = "cdc_ecig_licensure"
SOURCE_ID = "ne52-uraz"

METADATA = {
    "id": DATASET_ID,
    "title": "CDC E-Cigarette Licensure Legislation by State",
    "description": (
        "State-level e-cigarette licensure legislation from the State Tobacco Activities "
        "Tracking and Evaluation (STATE) System. Tracks laws governing e-cigarette sales, "
        "including over-the-counter and vending machine provisions. "
...
def run():
    """Transform, validate, and upload e-cigarette licensure data."""
