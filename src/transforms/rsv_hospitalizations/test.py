"""Validation for CDC RSV hospitalizations dataset."""
...
def test(table: pa.Table) -> None:
    """Validate RSV hospitalizations dataset output."""
    # Schema validation
    validate(table, {
        "not_null": [],
        "min_rows": 10000,
    ...
    # Valid sex categories
    sexes = set(table.column("sex").to_pylist())
    for sex in sexes:
        if sex:
            assert sex in ("Male", "Female", "All", "Unknown"), f"Invalid sex: {sex}"
